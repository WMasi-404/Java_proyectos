package Contenedores.AG_extends.grafoDirigido;

 import Objetos.MatrizArr_extends.*;
 import Contenedores.L1DL_extends.*;
public abstract class AbsGrafoD extends Contenedores.AbsGrafo implements TADs.OperacionesGD{
